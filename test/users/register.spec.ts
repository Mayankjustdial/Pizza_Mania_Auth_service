...
describe('POST /auth/register', () => {
    ...
    describe('Given all fields', () => {
        ...
        it('should return 404 if email is already exists', async () => {
            //   Arrange
            const userData = {
                id: 22,
                firstName: 'Mayank',
        ...
        it('should return the access token and refresh tokern inside a cookie', async () => {
            //   Arrange
            const userData = {
                firstName: 'Mayank',
                lastName: 'k',
    ...
    describe('fields are not in proper formate', () => {
        ...
        it('should return 400 status code if email is not a valid eamil', async () => {
            //   Arrange
            const userData = {
                id: 22,
                firstName: 'Mayank',
        ...
        it('should return 400 status code if password length is less than 6', async () => {
            //   Arrange
            const userData = {
                id: 22,
                firstName: 'Mayank',
